...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-primary">
		<div class="container-fluid">
			<a class="navbar-brand text-white"  href="main.jsp">JSP 게시판 웹 사이트</a> <a
				class="navbar-brand text-white" href="main.jsp">메뉴</a> <a
				class="navbar-brand text-white" href="bbs.jsp">게시판</a>
			<div class="dropdown">
				<button class="btn btn-outline-dark dropdown-toggle" type="button"
					id="dropdownMenuButton" data-bs-toggle="dropdown"
					aria-expanded="false" aria-haspopup="true">접 속 하 기</button>
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<li><a class="dropdown-item" href="join.jsp">회 원 가 입</a></li>
